...
public class MaculaSamplesBusApplication {
    public static void main(String[] args) {
        ConfigurableApplicationContext context = SpringApplication.run(MaculaSamplesBusApplication.class);
     ...
     */
    @EventListener(classes = {UserRemoteApplicationEvent.class})
    ...
    @EventListener
    public void onAckEvent(RemoteApplicationEvent event)
