...
public class HomeController {
    ...
    private final MaculaSamplesSeataBusinessApplication.OrderService orderService;

    private final MaculaSamplesSeataBusinessApplication.StorageService storageService;

    public HomeController(RestTemplate restTemplate, MaculaSamplesSeataBusinessApplication.OrderService orderService,
                          MaculaSamplesSeataBusinessApplication.StorageService storageService) {
