 ...
 * @since 2011-2-15
 */
public class MaculaJpaRepositoryFactoryBean<T extends JpaRepository<Object, Serializable>> extends
     ...
     * (non-Javadoc)
     *
     * @see org.springframework.data.org.macula.boot.core.repository.repository.support.
