...
import org.macula.boot.core.repository.jpa.TemplateQuery;
import org.macula.boot.core.repository.jpa.templatequery.TemplateQueryMethod;
...
public class FreemarkerSqlTemplates implements ResourceLoaderAware, InitializingBean {
    ...
    private void loadSqltoTemplateIfNeed(TemplateQueryMethod tqMethod) throws Exception {
        ...
        if (modified == null || modified) {
            ...
            // 2、====再加载Annotaion中的配置
            TemplateQuery templateQueryAnnontation = AnnotationUtils.findAnnotation(tqMethod.getMethod(), TemplateQuery.class);
