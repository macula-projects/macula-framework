...
public class TemplateQueryMethod extends JpaQueryMethod {
	 ...
	 * @param extractor
	 */
	public TemplateQueryMethod(Method method, RepositoryMetadata metadata, ProjectionFactory factory, QueryExtractor extractor) {
	...
	public boolean isTemplateQuery() {
		return null != AnnotationUtils.findAnnotation(method, org.macula.boot.core.repository.TemplateQuery.class);
	}
