package org.macula.boot.core.cache.aspect;
...
import org.macula.boot.core.cache.annotation.*;
import org.macula.boot.core.cache.cache.Cache;
import org.macula.boot.core.cache.expression.CacheOperationExpressionEvaluator;
...
import org.macula.boot.core.cache.setting.SecondaryCacheSetting;
import org.macula.boot.core.cache.support.CacheOperationInvoker;
import org.macula.boot.core.cache.support.KeyGenerator;
import org.macula.boot.core.cache.support.SerializationException;
import org.macula.boot.core.cache.support.SimpleKeyGenerator;
...
public class LayeringAspect {
    ...
    @Pointcut("@annotation(org.macula.boot.core.cache.annotation.Cacheable)")
    public void cacheablePointcut() {
    }

    @Pointcut("@annotation(org.macula.boot.core.cache.annotation.CacheEvict)")
    public void cacheEvictPointcut() {
    }

    @Pointcut("@annotation(org.macula.boot.core.cache.annotation.CachePut)")
