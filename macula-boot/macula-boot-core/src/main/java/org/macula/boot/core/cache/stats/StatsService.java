                    ...
                    for (Cache cache : caches) {
                        ...
                        try {
                            if (lock.tryLock()) {
                                ...
                                logger.info("Layering Cache 统计信息：{}", JSONUtils.objectToJson(cacheStats));
                            }
                        } catch (Exception e) {
