 ...
 */
package org.maculaframework.boot.core.uid.impl;

import org.maculaframework.boot.core.uid.UidGenerator;
import org.maculaframework.boot.core.uid.config.UidProperties;
import org.maculaframework.boot.core.uid.buffer.BufferPaddingExecutor;
import org.maculaframework.boot.core.uid.buffer.RejectedPutBufferHandler;
import org.maculaframework.boot.core.uid.buffer.RejectedTakeBufferHandler;
import org.maculaframework.boot.core.uid.buffer.RingBuffer;
import org.maculaframework.boot.core.uid.exception.UidGenerateException;
...
@ConfigurationProperties(prefix = "macula.uid.cached-uid-generator")
