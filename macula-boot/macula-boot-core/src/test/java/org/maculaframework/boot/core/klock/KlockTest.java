...
package org.maculaframework.boot.core.klock;
        ...
        while (i < 10) {
            ...
            executorService.submit(() -> {
                try {
                    ...
                    System.err.println("线程:[" + Thread.currentThread().getName() + "]拿到结果=》" + result + DateFormat.getDateTimeInstance().format(new Date()));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            });
