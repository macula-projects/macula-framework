 ...
 */
package org.maculaframework.boot.web.security.exception;
...
/**
 * <p> <b>OpenApiParameterException</b> is </p>
 * 
 * @since 2011-7-19
...
public class OpenApiParameterException extends MaculaException {
	 ...
	 * @param message
	 */
	public OpenApiParameterException(HttpServletRequest request, HttpServletResponse response, String message) {
		super(message);
		setRequest(request, response);
	}

	public OpenApiParameterException(HttpServletRequest request, HttpServletResponse response, String message, Throwable ex) {
		super(message, ex);
		setRequest(request, response);
	}
